...
namespace Griiv\Customer\Adapter\Customer\CommandHandler;
...
final class EditCustomerHandler extends AbstractCustomerHandler implements EditCustomerHandlerInterface
{
    ...
    public function handle(EditCustomerCommand $command)
    {
        ...
        if (isset($_POST['customer'], $_POST['customer']['code'])) {
            $customer->code = $_POST['customer']['code'];
        }

        if (isset($_POST['customer'], $_POST['customer']['code_internet'])) {
            $customer->code_internet = $_POST['customer']['code_internet'];
        }
